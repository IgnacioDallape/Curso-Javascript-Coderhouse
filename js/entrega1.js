...
while(consola == 1){
        ...
        if(consola == 1){
            calcularResultado()
                if(resultado > 0){
                    alert("El vuelto es de: " + resultado + " pesos");
                } else if (resultado < 0){
                    alert("ha pagado $" + pago + ", y debia pagar la suma de $", + cobro + ", por lo tanto le falta abonar un total de: $" + restante)
                }
                
                else{
                    alert("Se pagaron " + pago + " pesos, no hay que devolver vuelto, gracias!");
                }
        } else {
